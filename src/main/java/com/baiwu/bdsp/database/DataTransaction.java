...
public class DataTransaction extends SQLStatement implements ManagedExecutor {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.pzoom.database.ManagedExecutor#release()
	 */
	@Override
	public void release() {
		try {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.pzoom.database.ManagedExecutor#runningTime()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.pzoom.database.SQLStatement#executeQuery(java.lang.String, java.lang.Object[])
	 */
	@Override
